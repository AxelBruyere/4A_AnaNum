...
for k = 1:length(t)-1
    ...
    %2eme étape
    kf2 = f(t(k) + (pas/2), x(k) + (pas/2) * kf1, y(k) + (pas/2) * kg1, u(k) + (pas/2) * kh1, v(k)...
        + (pas/2) * ki1);
    kg2 = g(t(k) + (pas/2), x(k) + (pas/2) * kf1, y(k) + (pas/2) * kg1, u(k) + (pas/2) * kh1, v(k)...
        + (pas/2) * ki1);
    kh2 = h(t(k) + (pas/2), x(k) + (pas/2) * kf1, y(k) + (pas/2) * kg1, u(k) + (pas/2) * kh1, v(k)...
        + (pas/2) * ki1);
    ki2 = i(t(k) + (pas/2), x(k) + (pas/2) * kf1, y(k) + (pas/2) * kg1, u(k) + (pas/2) * kh1, v(k)...
        + (pas/2) * ki1);
    
    %3eme étape
    kf3 = f(t(k) + (pas/2), x(k) + (pas/2) * kf2, y(k) + (pas/2) * kg2, u(k) + (pas/2) * kh2, v(k)...
        + (pas/2) * ki2); 
    kg3 = g(t(k) + (pas/2), x(k) + (pas/2) * kf2, y(k) + (pas/2) * kg2, u(k) + (pas/2) * kh2, v(k)...
        + (pas/2) * ki2); 
    kh3 = h(t(k) + (pas/2), x(k) + (pas/2) * kf2, y(k) + (pas/2) * kg2, u(k) + (pas/2) * kh2, v(k)...
        + (pas/2) * ki2); 
    ki3 = i(t(k) + (pas/2), x(k) + (pas/2) * kf2, y(k) + (pas/2) * kg2, u(k) + (pas/2) * kh2, v(k)...
        + (pas/2) * ki2); 
